...
<template>
  <div>
    <ClientOnly>
      <PageHeader :title="current?.label ?? 'AI辅助测试设计'" :breadcrumb="current?.breadcrumb" />
      <template #fallback>
