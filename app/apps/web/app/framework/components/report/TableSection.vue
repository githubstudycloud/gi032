 ...
 */
import type { PrimaryView, PrimaryViewTab, ReportData } from '~/framework/types/report-config';
import type { PilotTable, TableColumn, TableRow } from '~/framework/types/overview-summary';
import { tabToColumns } from '~/framework/utils/header-modules';
